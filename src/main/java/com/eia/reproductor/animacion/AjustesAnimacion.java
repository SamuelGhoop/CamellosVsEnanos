...
public final class AjustesAnimacion {
    ...
    /** Factor de ampliacion de los sprites. */
    ...
    /**
     * Fila donde terminan los pies dentro del cuadro (el dibujo llega hasta y=114 y despues hay 4
     * px de aire).
     */
    ...
    /** Marco octogonal que hace de fondo del centinela. */
    ...
    /** Retardo inicial de cada barra, en segundos. */
